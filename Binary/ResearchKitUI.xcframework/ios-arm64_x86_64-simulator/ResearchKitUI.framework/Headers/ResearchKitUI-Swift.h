...
#ifndef RESEARCHKITUI_SWIFT_H
#define RESEARCHKITUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ResearchKitUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIView;
SWIFT_CLASS("_TtC13ResearchKitUI18SwiftUIViewFactory")
